...
class __TwigTemplate_94e6c632a77ff8bf9c9418ca19c3bc2175c0a50e7e8dd1b61a754704d3eeeefe extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_body($context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 19
        echo "    <nav class=\"navbar sticky-top nav-pills navbar-expand-lg navbar-dark bg-dark\">

            <a class=\"navbar-brand\" href=\"#\">";
        // line 21
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["session"] ?? null), "login", [], "any", false, false, false, 21), "prenom", [], "any", false, false, false, 21), "html", null, true);
        echo "</a>
                <a class=\"navbar-brand\">";
        // line 22
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["session"] ?? null), "login", [], "any", false, false, false, 22), "role", [], "any", false, false, false, 22), "html", null, true);
        echo "</a>
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["session"] ?? null), "login", [], "any", false, false, false, 32), "roles", [], "any", false, false, false, 32));
        ...
        echo "
                <li class=\"nav-item\">
                    <a class=\"nav-link\" href=\"/Matching\">Liste des matchs</a>
                </li>
                <li class=\"nav-item\">
                    <a class=\"nav-link\" href=\"/match\">Personne à proximité</a>
                </li>
        ...
        // line 52
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["session"] ?? null), "login", [], "any", false, false, false, 52), "id", [], "any", false, false, false, 52), "html", null, true);
        echo "\">Editer le profil</a>
                    </li>

            </ul>

            <form class=\"form-inline\" method=\"post\" action=\"/Rechercher\">
                <select class=\"btn btn-outline-success my-2 my-sm-0\" type=\"search\" id=\"validationCustom04\" name=\"search\" required>
                    <option selected disabled value=\"\">Projet</option>
...
<svg hidden=\"hidden\">
    ...
    {
        return array (  347 => 257,  139 => 52,  127 => 42,  121 => 41,  112 => 34,  109 => 33,  105 => 32,  92 => 22,  88 => 21,  84 => 19,  80 => 18,  54 => 2,  50 => 1,  46 => 18,  43 => 17,  41 => 1,);
    }
...
{% block body %}
    <nav class=\"navbar sticky-top nav-pills navbar-expand-lg navbar-dark bg-dark\">
            ...
            <a class=\"navbar-brand\" href=\"#\">{{ session.login.prenom }}</a>
                <a class=\"navbar-brand\">{{session.login.role}}</a>
                <a class=\"navbar-brand\" href=\"/logout\">Deconnexion</a>
...
{% endblock %}
", "/Article/Accueil.html.twig", "C:\\Git\\PullUp\\templates\\Article\\Accueil.html.twig");
    }
}
